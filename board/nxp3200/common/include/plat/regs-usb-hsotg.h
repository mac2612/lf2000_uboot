/* arch/arm/plat-nxp3200/include/plat/regs-usb-hsotg.h
 *
...
#ifndef __PLAT_NXP3200_REGS_USB_HSOTG_H
#define __PLAT_NXP3200_REGS_USB_HSOTG_H
...
#define S3C_GI2CCTL				S3C_HSOTG_REG(0x030)
#define S3C_GPVNDCTL				S3C_HSOTG_REG(0x034)
#define S3C_GGPIO				S3C_HSOTG_REG(0x038)
#define S3C_GUID				S3C_HSOTG_REG(0x03C)
#define S3C_GSNPSID				S3C_HSOTG_REG(0x040)
#define S3C_GHWCFG1				S3C_HSOTG_REG(0x044)
#define S3C_GHWCFG2				S3C_HSOTG_REG(0x048)
#define S3C_GHWCFG3				S3C_HSOTG_REG(0x04C)
#define S3C_GHWCFG4				S3C_HSOTG_REG(0x050)
#define S3C_GLPMCFG				S3C_HSOTG_REG(0x054)
...
#define S3C_DPTXFSIZn_DPTxFStAddr(_x)		((_x) << 0)
...
#define	S3C_PHYPOR				S3C_HSOTG_REG(0x1840)
#define S3C_INT_ENB				S3C_HSOTG_REG(0x1844)
#define S3C_INT_PEND				S3C_HSOTG_REG(0x1848)
#define	S3C_TESTPARM3				S3C_HSOTG_REG(0x184C)
#define	S3C_TESTPARM4				S3C_HSOTG_REG(0x1850)
#define	S3C_LINCTRL				S3C_HSOTG_REG(0x1854)
#define	S3C_TESTPARM6				S3C_HSOTG_REG(0x1858)
#define S3C_TESTPARM7				S3C_HSOTG_REG(0x185C)
#define S3C_TESTPARM8				S3C_HSOTG_REG(0x1860)
#define S3C_TESTPARM9				S3C_HSOTG_REG(0x1864)
#define S3C_USB_OTG_CLKENB			S3C_HSOTG_REG(0x1FC0)
#define S3C_USB_OTG_CLKGEN			S3C_HSOTG_REG(0x1FC4)

#define S3C_EPFIFO(_a)				S3C_HSOTG_REG(0x3040 + ((_a) * 0x0040))

#endif /* __PLAT_NXP3200_REGS_USB_HSOTG_H */
