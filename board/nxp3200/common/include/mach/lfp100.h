...
#define LFP100_PPATH_IUSB_100MA	 (0 << 0)
#define LFP100_PPATH_IUSB_500MA	 (1 << 0)
#define LFP100_PPATH_IUSB_1300MA (2 << 0)
#define LFP100_PPATH_IUSB_1800MA (3 << 0)
