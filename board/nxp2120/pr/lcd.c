...
#define	LCD_WIDTH 		(CFG_DISP_MAIN_SCREEN==MAIN_SCREEN_PRI ? CFG_DISP_PRI_RESOL_WIDTH  : CFG_DISP_SEC_RESOL_WIDTH)
#define	LCD_HEIGHT 		(CFG_DISP_MAIN_SCREEN==MAIN_SCREEN_PRI ? CFG_DISP_PRI_RESOL_HEIGHT : CFG_DISP_SEC_RESOL_HEIGHT)
