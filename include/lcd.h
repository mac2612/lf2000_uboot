...
typedef struct vidinfo {
	...
	u_char	vl_bpix;	/* Bits per pixel, 0=1, 1=2, 2=4, 3=8, 4=16, 5=32 */
...
typedef struct vidinfo {
	...
	u_char	vl_bpix;	/* Bits per pixel, 0 = 1, 1 = 2 bits, .. 5 = 32 bits */
...
/* bits per pixel, such that 2^n is number of bits per pixel */
#define LCD_MONOCHROME	0	/*  1 bit,  2^0 */
#define LCD_COLOR2	1	/*  2 bits, 2^1 */
#define LCD_COLOR4	2	/*  4 bits, 2^2 */
#define LCD_COLOR8	3	/*  8 bits, 2^3 */
#define LCD_COLOR16	4	/* 16 bits, 2^4 */
#define LCD_COLOR32	5	/* 32 bits, 2^5 */
...
#elif defined (CONFIG_LCD_SCREENS)
# define LCD_INFO_X		0
# define LCD_INFO_Y		(VIDEO_FONT_HEIGHT)
#else
...
# define CONSOLE_COLOR_GREY	0x00808080
...
# define CONSOLE_CHAR_ROWS	((panel_info.vl_row-BMP_LOGO_HEIGHT) \
					/ VIDEO_FONT_HEIGHT)
#else
# define CONSOLE_CHAR_ROWS	(panel_info.vl_row / VIDEO_FONT_HEIGHT)
#endif

#define CONSOLE_CHAR_ROW_FIRST	1
#define CONSOLE_CHAR_COLUMN_FIRST 1

#define CONSOLE_CHAR_COLS	(panel_info.vl_col / VIDEO_FONT_WIDTH)
#define CONSOLE_BIT_ROW_SIZE	(VIDEO_FONT_HEIGHT * lcd_line_length)
#define CONSOLE_BIT_ROW_FIRST	(lcd_console_address)
#define CONSOLE_BIT_ROW_SECOND	(lcd_console_address + CONSOLE_BIT_ROW_SIZE)
#define CONSOLE_BIT_ROW_LAST	(lcd_console_address + CONSOLE_BIT_SIZE \
					- CONSOLE_BIT_ROW_SIZE)
#define CONSOLE_BIT_SIZE	(CONSOLE_BIT_ROW_SIZE * CONSOLE_CHAR_ROWS)
#define CONSOLE_BIT_SCROLL_SIZE	(CONSOLE_BIT_SIZE - CONSOLE_BIT_ROW_SIZE)
