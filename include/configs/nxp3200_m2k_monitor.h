 ...
 *
 * Configuation settings for the LF2000 M2K board
 *
...
#define	CONFIG_BOOTARGS					CONFIG_SD_BOOTARGS
#define CONFIG_BOOTCOMMAND				CONFIG_SD_BOOTCOMMAND

/*-----------------------------------------------------------------------
 * Miscellaneous configurable options
 */
#define CONFIG_SYS_PROMPT				"nxp3200_m2k_monitor# "					/* Monitor Command Prompt   */
...
#define CONFIG_BOARD_REVISION_DEFAULT	0x204			/* default Board Revision M2K         */
