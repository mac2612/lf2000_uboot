 ...
 *
 * Configuration settings for the LF2000 L2K board
 *
...
#define CONFIG_SD_BOOTCOMMAND				"mmc init; mmc rescan 0; fatload mmc 0:2 80200000 uImage; setenv bootargs ${sdbootargs}; bootm"
 ...
 */
#define CONFIG_SYS_PROMPT				"nxp3200_l2k# "     						/* Monitor Command Prompt   */
...
/* Enable the #define of CONFIG_NAND_BBT_IN_NOR to enable creation and 
 * maintenace of base NAND bad block table in NOR.
 */
/* *
/
#define CONFIG_NAND_BBT_IN_NOR
/
* */

#ifdef CONFIG_NAND_BBT_IN_NOR
/* Enable the #define of CONFIG_DEBUG_BBT_IN_NOR to enable debug output 
 * related to creation and maintenance of base NAND bad block table in NOR.
 */
/* */
#define CONFIG_DEBUG_BBT_IN_NOR
/* */
...
/*-----------------------------------------------------------------------
 * NOR flash support (in order to erase/write bad block table in NOR.
 */
#define CONFIG_MTD_DEVICE
#define CONFIG_MTD_PARTITIONS
...
#define CONFIG_SYS_FLASH_BASE 0			/* for NOR boot */
//#define CONFIG_SYS_FLASH_BASE 0x34000000	/* for SD or other boot */
...
#define CONFIG_SYS_FLASH_EMPTY_INFO             /* print 'E' for empty sector on */ 
						/* flinfo */
//#define CONFIG_SYS_FLASH_QUIET_TEST     1       /* don't warn upon unknwn flash  */

#define CONFIG_SYS_FLASH_LEGACY_512Kx8	1	/* for jedec_flash.c's */
						/*   jedec_table[]     */
