 ...
 *
 * Configuration settings for the LF2000 Rio board
 *
 ...
 */
#define CONFIG_SYS_PROMPT	"nxp3200_rio# "    /* Monitor Command Prompt */
...
#define CONFIG_BOARD_REVISION_DEFAULT	0x321			/* Rio KND 800x480 screen with two cameras */
