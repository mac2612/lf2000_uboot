 ...
 *
 * Configuation settings for the Nexell VTK board.
 *
...
//#define CONFIG_SD_BOOTARGS				"console=ttyS0,115200n8 root=/dev/mmcblk0p3 rootfstype=ext4 rw rootwait ramdisk=24576 androidboot.hardware=valencia androidboot.mode=normal androidboot.console=ttyS0 init=/init HWACCEL=0 ubversion=" CONFIG_IDENT_STRING
 ...
 */
#define CONFIG_SYS_PROMPT				"nxp3200 vtk# "     						/* Monitor Command Prompt   */
...
#define CONFIG_BOARD_REVISION_DEFAULT	0x201			/* default Board Revision VTK         */
